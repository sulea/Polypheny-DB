...
public class FlatLists {
     ...
     *
     * The elements need not be comparable, and the returned list may not implement {@link Comparable}.
     * Elements may be null.
     *
     * @param t Array of members of list
     * @param <T> Element type
    ...
    private static <T extends Object & Comparable> ComparableList<T> flatList_( T[] t, boolean copy ) {
        switch ( t.length ) {
            ...
            default:
                // REVIEW: AbstractList contains a modCount field; we could write our own implementation and reduce creation overhead a bit.
                if ( copy ) {
    ...
    /**
     * Returns a list that consists of a given list plus an element, guaranteed to be an {@link ImmutableList}.
     */
    ...
    /**
     * Returns a map that consists of a given map plus an (key, value), guaranteed to be an {@link ImmutableMap}.
     */
     ...
     * Unlike {@link java.util.ArrayList} or {@link java.util.Arrays#asList(Object[])} there is no array, only one piece of memory allocated, therefore is very compact and cache and CPU efficient.
     *
     * The list is read-only and cannot be modified or re-sized.
     * The element may be null.
     *
     * The list is created via {@link FlatLists#of}.
     *
     * @param <T> Element type
     */
     ...
     * The elements may be null.
     *
     * The list is created via {@link FlatLists#of(java.util.List)}.
     *
     * @param <T> Element type
     */
     ...
     *
     * You can create an instance whose type parameter {@code T} does not extend {@link Comparable}, but you will get a {@link ClassCastException} at runtime when you call
     * {@link #compareTo(Object)} if the elements of the list do not implement {@code Comparable}.
     *
     * @param <T> element type
     */
    ...
    /**
     * Wrapper around a list that makes it implement the {@link Comparable} interface using lexical ordering. The elements must be comparable.
     *
     * @param <T> element type
     */
