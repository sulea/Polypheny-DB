...
import org.polypheny.db.sql.sql.SqlFilterOperator;
import org.polypheny.db.sql.sql.SqlFunction;
import org.polypheny.db.sql.sql.SqlGroupedWindowFunction;
import org.polypheny.db.sql.sql.SqlInternalOperator;
import org.polypheny.db.sql.sql.SqlLateralOperator;
import org.polypheny.db.sql.sql.SqlLiteral;
import org.polypheny.db.sql.sql.SqlNode;
import org.polypheny.db.sql.sql.SqlNumericLiteral;
import org.polypheny.db.sql.sql.SqlOverOperator;
import org.polypheny.db.sql.sql.SqlPostfixOperator;
import org.polypheny.db.sql.sql.SqlPrefixOperator;
import org.polypheny.db.sql.sql.SqlProcedureCallOperator;
import org.polypheny.db.sql.sql.SqlRankFunction;
...
import org.polypheny.db.sql.sql.SqlWithinGroupOperator;
import org.polypheny.db.sql.sql.SqlWriter;
import org.polypheny.db.sql.sql.fun.OracleSqlOperatorTable;
import org.polypheny.db.sql.sql.fun.SqlAbstractTimeFunction;
import org.polypheny.db.sql.sql.fun.SqlAnyValueAggFunction;
import org.polypheny.db.sql.sql.fun.SqlArgumentAssignmentOperator;
import org.polypheny.db.sql.sql.fun.SqlArrayQueryConstructor;
import org.polypheny.db.sql.sql.fun.SqlArrayValueConstructor;
import org.polypheny.db.sql.sql.fun.SqlAvgAggFunction;
import org.polypheny.db.sql.sql.fun.SqlBaseContextVariable;
import org.polypheny.db.sql.sql.fun.SqlBetweenOperator;
import org.polypheny.db.sql.sql.fun.SqlBitOpAggFunction;
import org.polypheny.db.sql.sql.fun.SqlCaseOperator;
import org.polypheny.db.sql.sql.fun.SqlCastFunction;
import org.polypheny.db.sql.sql.fun.SqlCoalesceFunction;
import org.polypheny.db.sql.sql.fun.SqlCollectionTableOperator;
import org.polypheny.db.sql.sql.fun.SqlColumnListConstructor;
import org.polypheny.db.sql.sql.fun.SqlConvertFunction;
import org.polypheny.db.sql.sql.fun.SqlCountAggFunction;
import org.polypheny.db.sql.sql.fun.SqlCovarAggFunction;
import org.polypheny.db.sql.sql.fun.SqlCurrentDateFunction;
import org.polypheny.db.sql.sql.fun.SqlCursorConstructor;
import org.polypheny.db.sql.sql.fun.SqlDatePartFunction;
...
import org.polypheny.db.sql.sql.fun.SqlDefaultOperator;
import org.polypheny.db.sql.sql.fun.SqlDistanceFunction;
import org.polypheny.db.sql.sql.fun.SqlDotOperator;
import org.polypheny.db.sql.sql.fun.SqlExtendOperator;
import org.polypheny.db.sql.sql.fun.SqlExtractFunction;
import org.polypheny.db.sql.sql.fun.SqlFirstLastValueAggFunction;
import org.polypheny.db.sql.sql.fun.SqlFloorFunction;
import org.polypheny.db.sql.sql.fun.SqlGroupIdFunction;
import org.polypheny.db.sql.sql.fun.SqlGroupingFunction;
import org.polypheny.db.sql.sql.fun.SqlHistogramAggFunction;
import org.polypheny.db.sql.sql.fun.SqlInOperator;
import org.polypheny.db.sql.sql.fun.SqlItemOperator;
import org.polypheny.db.sql.sql.fun.SqlJsonApiCommonSyntaxOperator;
import org.polypheny.db.sql.sql.fun.SqlJsonArrayAggAggFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonArrayFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonExistsFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonObjectAggAggFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonObjectFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonQueryFunction;
import org.polypheny.db.sql.sql.fun.SqlJsonValueExpressionOperator;
import org.polypheny.db.sql.sql.fun.SqlJsonValueFunction;
import org.polypheny.db.sql.sql.fun.SqlLeadLagAggFunction;
import org.polypheny.db.sql.sql.fun.SqlLikeOperator;
import org.polypheny.db.sql.sql.fun.SqlLiteralChainOperator;
import org.polypheny.db.sql.sql.fun.SqlMapQueryConstructor;
import org.polypheny.db.sql.sql.fun.SqlMapValueConstructor;
import org.polypheny.db.sql.sql.fun.SqlMetaFunction;
import org.polypheny.db.sql.sql.fun.SqlMinMaxAggFunction;
import org.polypheny.db.sql.sql.fun.SqlMonotonicBinaryOperator;
import org.polypheny.db.sql.sql.fun.SqlMonotonicUnaryFunction;
import org.polypheny.db.sql.sql.fun.SqlMultisetMemberOfOperator;
import org.polypheny.db.sql.sql.fun.SqlMultisetQueryConstructor;
import org.polypheny.db.sql.sql.fun.SqlMultisetSetOperator;
import org.polypheny.db.sql.sql.fun.SqlMultisetValueConstructor;
import org.polypheny.db.sql.sql.fun.SqlNewOperator;
import org.polypheny.db.sql.sql.fun.SqlNthValueAggFunction;
import org.polypheny.db.sql.sql.fun.SqlNtileAggFunction;
import org.polypheny.db.sql.sql.fun.SqlNullifFunction;
import org.polypheny.db.sql.sql.fun.SqlOverlapsOperator;
import org.polypheny.db.sql.sql.fun.SqlOverlayFunction;
import org.polypheny.db.sql.sql.fun.SqlPositionFunction;
import org.polypheny.db.sql.sql.fun.SqlQuantifyOperator;
import org.polypheny.db.sql.sql.fun.SqlRandFunction;
import org.polypheny.db.sql.sql.fun.SqlRandIntegerFunction;
import org.polypheny.db.sql.sql.fun.SqlRegrCountAggFunction;
import org.polypheny.db.sql.sql.fun.SqlRollupOperator;
...
import org.polypheny.db.sql.sql.fun.SqlStringContextVariable;
import org.polypheny.db.sql.sql.fun.SqlSubstringFunction;
import org.polypheny.db.sql.sql.fun.SqlSumAggFunction;
import org.polypheny.db.sql.sql.fun.SqlSumEmptyIsZeroAggFunction;
import org.polypheny.db.sql.sql.fun.SqlThrowOperator;
import org.polypheny.db.sql.sql.fun.SqlTimestampAddFunction;
import org.polypheny.db.sql.sql.fun.SqlTimestampDiffFunction;
import org.polypheny.db.sql.sql.fun.SqlTranslate3Function;
