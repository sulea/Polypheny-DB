...
//        return "sch" + schemaId;
    ...
    public void updatePhysicalColumnName( long columnId, String updatedName, boolean updatePosition ) {
        ...
        CatalogPartitionPlacement partitionPlacement = catalog.getPartitionPlacement( this.storeId, placement.tableId, catalog.getTable( placement.tableId ).partitionProperty.partitionIds.get( 0 ) );
